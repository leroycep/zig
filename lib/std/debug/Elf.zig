...
pub fn open(d: *Elf, gpa: Allocator) OpenError!void {
...
fn scanAllSymbols(ei: *Elf, allocator: Allocator) OpenError!void {
...
pub fn load(
    ...
    var sections: Elf.SectionArray = Elf.null_section_array;
    ...
    for (shdrs) |*shdr| {
        ...
        inline for (@typeInfo(Elf.Section.Id).@"enum".fields, 0..) |sect, i| {
    ...
    const missing_debug_info =
        sections[@intFromEnum(Elf.Section.Id.strtab)] == null or
        sections[@intFromEnum(Elf.Section.Id.symtab)] == null;
...
pub fn section(ei: Elf, elf_section: Section.Id) ?[]const u8 {
